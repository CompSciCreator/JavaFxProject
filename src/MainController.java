...
public class MainController  {
    ...
    private void setDelay() {
        ...
        speedLabel.setText("Simulated Time For Each Loop: "+delay+" ms");
    ...
    public void updateChart(int[] Tarray) {  // Updating the BarChart with the given array data
        ...
        if (bubbleSorting) { //implementing bubblesort style within the method data
            ...
            BCArray.lookupAll(".defualt-color0.chart-bar")
                .forEach(n -> n.setStyle("-fx-bar-fill: #34495e;")); //style for all bars
            BCArray.lookup(".chart-plot-background").setStyle("-fx-background-color: #ecf0f1;"); //chart bar graph
            BCArray.setStyle("-fx-background-color: #ecf0f1;");
            ...
            BCArray.lookup(".chart-plot-background").setStyle("-fx-background-color: #f5f5f5;"); //chart bg 
            BCArray.setStyle("-fx-background-color: #f5f5f5;");
